    ...
    <form className='w-11/12 rounded-lg bg-white h-auto mt-16 flex flex-col items-center pt-8 pb-8 shadow-md'>
      ...
      <div className='w-5/6 h-auto max-sm:mt-0 max-sm:ml-0 ml-2 mt-4 flex justify-center max-sm:items-center max-sm:flex-col'>
        <div className=' max-sm:ml-0 flex flex-col'>
          <label htmlFor="input_nombre" className="block text-sm max-sm:ml-1  self-start font-medium text-gray-900 ">Nombre</label>
          <input type="text" id="input_nombre" className="rounded block max-sm:ml-1 max-sm:w-64 w-48 p-2 text-sm text-gray-900 border border-gray-300 bg-gray-50 focus:ring-red-500 focus:border-red-500  dark:border-gray-600 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500 outline-none transition-all duration-300" placeholder='Ingrese su nombre' required/>
        </div>
        <div className=' flex flex-col max-sm:mt-3'>
          <label htmlFor="input_apellido" className="block text-sm max-sm:ml-1 ml-6 self-start font-medium text-gray-900 ">Apellido</label>
          <input type="text" id="input_apellido" className="rounded block ml-6 max-sm:ml-1 max-sm:w-64 w-48 p-2 text-sm text-gray-900 border border-gray-300 bg-gray-50 focus:ring-red-500 focus:border-red-500 dark:border-gray-600 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500 outline-none transition-all duration-300" placeholder='Ingrese su apellido' required/>
        </div>
      </div>
